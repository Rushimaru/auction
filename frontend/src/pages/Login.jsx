...
const Login = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      // On success, the navigation will naturally clear the loader component
  ...
  return (
    <>
      ...
      <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh', visibility: loading ? 'hidden' : 'visible' }}>
